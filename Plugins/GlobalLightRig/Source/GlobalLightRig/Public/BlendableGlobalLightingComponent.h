...
#include "BlendableGlobalLightingComponent.generated.h"

class UGlobalLightingBlendable;

UCLASS(Blueprintable, CollapseCategories, EditInlineNew, ClassGroup=Custom, meta=(BlueprintSpawnableComponent))
class GLOBALLIGHTRIG_API UBlendableGlobalLightingComponent : public USceneComponent, public IGlobalLightingBlendableInterface {
    GENERATED_BODY()
public:
    ...
    UBlendableGlobalLightingComponent();
