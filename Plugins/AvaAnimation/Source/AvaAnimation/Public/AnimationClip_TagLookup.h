...
#include "AnimationClip_TagLookup.generated.h"
...
class AVAANIMATION_API UAnimationClip_TagLookup : public UAnimationClipProvider, public IAnimationArchitect_TagProviderInterface {
    GENERATED_BODY()
public:
