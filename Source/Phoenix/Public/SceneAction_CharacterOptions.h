...
class PHOENIX_API USceneAction_CharacterOptions : public USceneRigObjectActionBase, public ISceneRigCharacterOptions {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    USceneRigCharacterOptionsAsset* OPTIONS;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    EOverrideNPCStateOnFinish OverrideNPCStateOnFinish;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bSynchronizeLocation;
    
    USceneAction_CharacterOptions();
