...
#include "SceneAction_GameOptions.generated.h"

class USceneRigGameOptionsAsset;

UCLASS(Blueprintable, CollapseCategories, EditInlineNew)
class PHOENIX_API USceneAction_GameOptions : public USceneRigActionBase, public ISceneRigGameOptions {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    USceneRigGameOptionsAsset* Settings;
