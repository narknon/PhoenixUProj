...
#include "SceneRigStage_SimpleConversation.generated.h"

class USceneRigProvider;

UCLASS(Blueprintable)
class PHOENIX_API USceneRigStage_SimpleConversation : public USceneRigStage {
    GENERATED_BODY()
public:
    ...
    USceneRigProvider* ActiveSceneRig;
    
    USceneRigStage_SimpleConversation();
};
